...
const { createCourse, courseById, lessonById, getCourseById, getCoursePhoto, handleSearch, renderCreateCourseForm, addWistlist,removeWistlist, buyCourse, renderLearnCourse } = require('../controller/course');
